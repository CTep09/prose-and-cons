...
import FriendStarRating from "../widgets/FriendStarRating";
import FriendReadStatus from "../widgets/FriendReadStatus";

export default function FriendBookCard(props) {
  return (
    <Center py={12}>
      <Flex
